...
CREATE TABLE books (    
    ...
    descr VARCHAR(5000) );
     ...
     INSERT INTO books (title, Author, isbn, image_url, descr) VALUES ('A&D in Coding301', 'Aghiad','ISBN_13 9780441013456','https://books.google.com/books/content?id=vHRVDwAAQBAJ&printsec=frontcover&img=1&zoom=1&edge=curl&source=gbs_api', 'andventures in Cooding');